...
--ESTADO
INSERT INTO estado (sigla, tipo_regiao, ibge_id, pais_id, nome, conjuncao, reference) VALUES('SP', 'SUDESTE', '35', (SELECT id FROM pais WHERE ddi = '055'), 'São Paulo', 'de SP', '01');
...
INSERT INTO estado (sigla, tipo_regiao, ibge_id, pais_id, nome, conjuncao, reference) VALUES('MA', 'NORDESTE', '33', (SELECT id FROM pais WHERE ddi = '055'), 'Maranhão', 'de MA', '02');
...
INSERT INTO localidade (nome_abreviado, nome, cep, situacao, loc_nu_sequencial_sub, temp, estado_id, tipo_localidade_id, municipio_id, populacao_data, ibge_id, naturalidade, ddd, municipio_pai_id, conjuncao, populacao, reference, ibge_id_2) VALUES ('Ananás','Ananás',null,0,0,null,3,3,2305,null,'1701002','Ananás',null,null,'De',0,'01100357',null);
...
INSERT INTO localidade (nome_abreviado, nome, cep, situacao, loc_nu_sequencial_sub, temp, estado_id, tipo_localidade_id, municipio_id, populacao_data, ibge_id, naturalidade, ddd, municipio_pai_id, conjuncao, populacao, reference, ibge_id_2) VALUES ('Poá','Poá',null,0,0,null,2,3,7778,null,null,'Poà',null,null,'De',0,'01240936',null);
...
INSERT INTO localidade (nome_abreviado, nome, cep, situacao, loc_nu_sequencial_sub, temp, estado_id, tipo_localidade_id, municipio_id, populacao_data, ibge_id, naturalidade, ddd, municipio_pai_id, conjuncao, populacao, reference, ibge_id_2) VALUES ('Araxás','Araxás (Presidente Bernardes)','19310000',0,9530,null,1,2,9637,null,'3541208','Araxás',null,9213,'De',0,'01270057',null);
...
INSERT INTO localidade (nome_abreviado, nome, cep, situacao, loc_nu_sequencial_sub, temp, estado_id, tipo_localidade_id, municipio_id, populacao_data, ibge_id, naturalidade, ddd, municipio_pai_id, conjuncao, populacao, reference, ibge_id_2) VALUES ('Arco-Íris','Arco-Íris','17630000',0,0,null,1,1,8791,'2010-01-28 14:42:57','3503356','Arco-Íris',null,null,'De',2002,'01270059',null);
...
INSERT INTO localidade (nome_abreviado, nome, cep, situacao, loc_nu_sequencial_sub, temp, estado_id, tipo_localidade_id, municipio_id, populacao_data, ibge_id, naturalidade, ddd, municipio_pai_id, conjuncao, populacao, reference, ibge_id_2) VALUES ('Paulínia','Paulínia',null,1,0,null,1,1,9161,'2010-01-28 14:42:57','3536505','Paulínia',null,null,'De',73118,'01270583',null);

--BAIRRO
INSERT INTO public.bairro (localidade_id, nome, nome_abreviado) VALUES(12, 'João Aranha', 'J Aranha');
